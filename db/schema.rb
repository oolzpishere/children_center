...
ActiveRecord::Schema.define(version: 2019_09_24_084934) do
  ...
  create_table "matches", force: :cascade do |t|
    ...
    t.index ["serial_number"], name: "index_matches_on_serial_number"
    t.index ["unionid"], name: "index_matches_on_unionid"
  end
